This React App allows users to add tasks to a list. With the use of a custom hook, functionalities for getting and posting data to a Firebase Realtime database is handled.
